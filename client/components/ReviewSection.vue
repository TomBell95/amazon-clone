      ...
      <div class="row">
        <div class="col-lg-4 col-md-5 col-sm-12">
          ...
          <a href="#" class="a-color-base">
            <h2>{{ product.reviews.rating }} customer reviews</h2>
          </a>
          ...
          <div class="cr-widget-focalreviews">
            <div class="card-padding">
              <div class="review-header">
                <h3>
                  <span class="a-size-base">Showing 1-8 of {{ product.reviews.length }}</span>
                </h3>
              </div>
          ...
          <div class="review-footer">
            <div class="a-row">
              <span id="a-autoid-15" class="a-button a-button-base writeReviewButton">
                <span class="a-button-inner">
                  <!-- <a href="#" class="a-button-text" role="button">/a> -->
                  <NuxtLink class="a-button-text" :to="`/reviews/${product._id}`">
