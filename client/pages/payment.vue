          ...
          <div class="col-sm-6">
            ...
            <div class="a-section">
              ...
              <div class="a-section a-spacing-none a-spacing-top-small">
                <b>The total price is £{{ getCartTotalPriceWithShipping.toFixed(2) }}</b>
              </div>
...
export default {
  ...
  computed: {
    ...mapGetters(['getCart', 'getCartTotalPriceWithShipping','getEstimatedDelivery', 'clearCart'])
  },
  mounted(){
    // eslint-disable-next-line no-undef
    this.stripe = Stripe('pk_test_51K0PG0BoJa1f11Xlmpc3baEiw84bjFHuXGyWc2u5NkaWc2zbtBQqq8Ampkh55TVqaXxQOkmkOLwmHDHyTddlvoFZ00L2vafcuZ');
