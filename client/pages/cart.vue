                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-8">
                          ...
                          <div class="sc-action-links">
                            ...
                            <!-- Delete button -->
                            <span class="a-size-small">
                              <a href="#" @click="$store.commit('removeProduct', product)">Remove all</a>
                            </span>
                            &nbsp;
                            &nbsp;
                          </div>
                ...
                <div class="text-right">
                  ...
                  <p class="a-spacing-none a-spacing-top-mini">
                    ...
                    <span class="a-color-price a-text-bold">
                      <!-- Cart Total Price -->
                      <span class="a-size-medium a-color-price">£{{ parseFloat(getCartTotalPrice).toFixed(2) }}</span>
                    </span>
                  </p>
                </div>
              </form>
                  ...
                  <div>
                    <span class="a-spacing-small a-button-primary a-button-icon">
                      <span class="a-button-inner">
                        <NuxtLink to="/placeorder" class="a-button-text">
                          Proceed to checkout
                        </NuxtLink>
                      </span>
                    </span>
