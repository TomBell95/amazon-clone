                    ...
                    <div class="a-row">
                      <div class="displayAddressDiv">
                        ...
                        <ul class="displayAddressUL">
                          ...
                          <li>{{ $auth.$state.user.address.postcode }}</li>
                      ...
                      <fieldset>
                        ...
                        <div class="a-spacing-mini wednesday">
                          ...
                          <span class="a-radio-label">
                            ...
                            >£2.99&nbsp;-&nbsp;Standard International Shipping - No Tracking</span>
                          </span>
                        </div>
                        <br />
                        <div class="a-spacing-mini tuesday">
                          ...
                          <span class="a-radio-label">
                            <span class="a-color-success">
                              <strong>Averages 1 business day</strong>
                            </span>
                            <br />
                            <span class="a-color-secondary">£4.99&nbsp;-&nbsp;Shipping</span>
                          </span>
                        </div>
                      </fieldset>
                    </div>
              ...
              <div class="a-box-inner">
                <div class="a-row a-spacing-micro">
                  <nuxt-link to="/payment">
                    <span class="a-button-place-order">Place your order in GBP</span>
                  </nuxt-link>
                </div>
                ...
                <div class="a-row">
                  ...
                  <div class="order-summary" style="font-size: 12px;">
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">£{{ parseFloat(getCartTotalPrice).toFixed(2) }}</div>
                    </div>
                    <div class="row">
                      <!-- Shipping cost -->
                      <div class="col-sm-6">Shipping & handling:</div>
                      <div class="col-sm-6 text-right">£{{ shipmentPrice }}</div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">£{{ parseFloat(getCartTotalPriceWithShipping).toFixed(2) }}</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">
                        <!-- Total Price with Shipping -->
                        <div class="a-color-price a-size-medium a-text-bold">£{{ parseFloat(getCartTotalPriceWithShipping).toFixed(2) }}</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="a-row">
                    ...
                    <fieldset class="pl-3">
                      <span style="margin-left: 1rem;">
                        ...
                        <span class="a-radio-label">GBP</span>
                      </span>
                      <div class="a-row">
